...
$sql="SELECT * FROM $tbl_name WHERE déforestation='$id'";
...
<head>
    <title>EDIT DÉFORESTATION</title>
...
<div id="head">
    <header>
        <h2 > EDIT/DELETE DÉFORESTATION </h2>
        ...
        <tr><td bgcolor="blue" style='width: 850px'>
                <table cellpadding='0' cellspacing='5px' border='5px' width='100%'>
                    ...
                    <tr><td bgcolor=#eee style="padding:8px"><br>
                            <form method="post" action="editdéforestationaction.php?id=<?php echo $id ?>" name="addsynonyms" target="_top" onsubmit="return validateAdmin()">
                                <table >
                                    <tr >
                                        <td style="padding:4px" ><font face="verdana,arial" size=2>Déforestation </font></td>
                                        <td  ><input type="text" name="txtDéforestation" size="21"></td>

                                    </tr>
                                    <tr>
                                        <td style="padding:4px" ><font face="verdana,arial" size=2>déforestation syn 1 </font></td>
                                        <td style="size:160" ><input type="text" name="txtdéforestationsyn1" size="21" ></td>
                                    </tr>
                                    <tr>
                                        <td style="padding:4px" ><font face="verdana,arial" size=2>déforestation syn 2 </font></td>
                                        <td style="size:160" ><input type="text" name="txtdéforestationsyn2" size="21" ></td>
                                    </tr>
                                    ...
                                    <tr >
                                        ...
                                        <td style="padding:4px" ><input style="padding:4px" type="submit" value="Save">
                                            <input style="padding:4px" type="button" value="Delete" name="btnDelete" onclick="javascript:location.href='deldéforestation.php?id=<?php echo $id ?>'">
                                            <input style="padding:4px" type="button" value="Cancel" name="btnCancel" onclick="javascript:location.href='managedéforestation.php'"></td>
                                    </tr>
