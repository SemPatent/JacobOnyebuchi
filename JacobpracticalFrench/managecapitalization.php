...
<?php
    ...
    $sql="SELECT Capitalization,capitalization_syn_1,capitalization_syn_2,capitalization_syn_3 FROM $tbl_name ";
...
<head>
	<title>MANAGE CAPITALIZATION</title>
...
<body>
	...
	<div id="head">
         <header>
           <h2 > MANAGE CAPITALIZATION</h2>
             <ul class="list" style="margin-top: 50px; ">
                 <li style=" font-size: 14px;"><a style="color: #3366FF" href="home.php"><b>HOME</b></a></li>
                 <li style=" font-size: 14px;"><a style="color: #3366FF" href="addcapitalization.php"><b>ADD CAPITALIZATION</b></a></li>
                    ...
                    <tr><td bgcolor=#eee style="padding:8px"><br>
                        <table >
                            <tr >
                                <?php
                                echo "\t<tr>\n";
                                echo "\t\t<td style='padding:4px'><b><h3>Capitalization</h3></b></td>";
                                echo "\t\t<td style='padding:4px'><b><h3>capitalization syn 1</h3></b></td>";
                                echo "\t\t<td style='padding:4px'><b><h3>capitalization syn 2</h3></b></td>";
                                echo "\t\t<td style='padding:4px'><b><h3>capitalization syn 3</h3></b></td>";
                                echo "\t</tr>\n";
                                    // Printing results in HTML
                                    while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
                                        $id = $line['Capitalization'];
                                        echo "\t<tr>\n";
                                        foreach ($line as $col_value) {
                                            echo "\t\t<td style='padding:4px'>$col_value</td>";
                                        }
                                        echo "\t\t<td style='padding:4px'><a href='editcapitalization.php?id=$id'>Edit Record $id </a></td>\n";
                                        echo "\t</tr>\n";
                                    }
                                    // Free resultset
