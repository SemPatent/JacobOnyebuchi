...
$sql="SELECT Déforestation,déforestation_syn_1,déforestation_syn_2 FROM $tbl_name ";
...
<head>
    <title>MANAGE DÉFORESTATION</title>
...
<div id="head">
    <header>
        <h2 > MANAGE DÉFORESTATION</h2>
        <ul class="list" style="margin-top: 50px; ">
            <li style=" font-size: 14px;"><a style="color: #3366FF" href="home.php"><b>HOME</b></a></li>
            <li style=" font-size: 14px;"><a style="color: #3366FF" href="adddéforestation.php"><b>ADD DÉFORESTATION</b></a></li>
                    ...
                    <tr><td bgcolor=#eee style="padding:8px"><br>
                            <table >
                                <tr >
                                    <?php
                                    echo "\t<tr>\n";
                                    echo "\t\t<td style='padding:4px'><b><h3>Déforestation </h3></b></td>";
                                    echo "\t\t<td style='padding:4px'><b><h3>déforestation syn 1</h3></b></td>";
                                    echo "\t\t<td style='padding:4px'><b><h3>déforestation syn 2</h3></b></td>";
                                    echo "\t</tr>\n";
                                    // Printing results in HTML
                                    while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
                                        $id = $line['Déforestation'];
                                        echo "\t<tr>\n";
                                        foreach ($line as $col_value) {
                                            echo "\t\t<td style='padding:4px'>$col_value</td>";
                                        }
                                        echo "\t\t<td style='padding:4px'><a href='editdéforestation.php?id=$id'>Edit Record $id </a></td>\n";
                                        echo "\t</tr>\n";
                                    }
                                    // Free resultset
