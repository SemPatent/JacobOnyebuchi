...
$sql="SELECT Ballottine,ballottine_syn_1,ballottine_syn_2
 FROM $tbl_name ";
...
<div id="head">
    <header>
        <h2 > MANAGE BALLOTTINE</h2>
        <ul class="list" style="margin-top: 50px; ">
            <li style=" font-size: 14px;"><a style="color: #3366FF" href="home.php"><b>HOME</b></a></li>
            <li style=" font-size: 14px;"><a style="color: #3366FF" href="addballottine.php"><b>ADD BALLOTTINE</b></a></li>
                    ...
                    <tr><td bgcolor=#eee style="padding:8px"><br>
                            <table >
                                <tr >
                                    <?php
                                    echo "\t<tr>\n";
                                    echo "\t\t<td style='padding:4px'><b><h3>Ballottine </h3></b></td>";
                                    echo "\t\t<td style='padding:4px'><b><h3>ballottine syn 1</h3></b></td>";
                                    echo "\t\t<td style='padding:4px'><b><h3>ballottine syn 2</h3></b></td>";
                                    echo "\t</tr>\n";
                                    ...
                                    while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
                                        ...
                                        echo "\t\t<td style='padding:4px'><a href='editballottine.php?id=$id'>Edit Record $id </a></td>\n";
                                        echo "\t</tr>\n";
                                    }
                                    // Free resultset
