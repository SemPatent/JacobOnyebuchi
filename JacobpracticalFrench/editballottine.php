...
$sql="SELECT * FROM $tbl_name WHERE Ballottine='$id'";
                ...
                <table cellpadding='0' cellspacing='5px' border='5px' width='100%'>
                    ...
                    <tr><td bgcolor=#eee style="padding:8px"><br>
                            <form method="post" action="editbeginaction.php?id=<?php echo $id ?>" name="addsynonyms" target="_top" onsubmit="return validateAdmin()">
                                <table >
                                    <tr >
                                        <td style="padding:4px" ><font face="verdana,arial" size=2>Ballottine </font></td>
                                        <td  ><input type="text" name="txtBallottine" size="21"></td>

                                    </tr>
                                    <tr>
                                        <td style="padding:4px" ><font face="verdana,arial" size=2>ballottine syn 1 </font></td>
                                        <td style="size:160" ><input type="text" name="txtballottinesyn1" size="21" ></td>
                                    </tr>
                                    <tr>
                                        <td style="padding:4px" ><font face="verdana,arial" size=2>ballottine syn 2 </font></td>
                                        <td style="size:160" ><input type="text" name="txtballottinesyn2" size="21" ></td>
                                    </tr>
                                    ...
                                    <tr >
                                        ...
                                        <td style="padding:4px" ><input style="padding:4px" type="submit" value="Save">
                                            <input style="padding:4px" type="button" value="Delete" name="btnDelete" onclick="javascript:location.href='delballottine.php?id=<?php echo $id ?>'">
                                            <input style="padding:4px" type="button" value="Cancel" name="btnCancel" onclick="javascript:location.href='manageballottine.php'"></td>
                                    </tr>
