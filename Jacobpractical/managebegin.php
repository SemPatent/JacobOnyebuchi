...
$sql="SELECT Begin,begin_syn_1,begin_syn_2,begin_syn_3,begin_syn_4,begin_syn_5,begin_syn_6,begin_syn_7,begin_syn_8
 FROM $tbl_name ";
...
<div id="head">
    <header>
        ...
        <ul class="list" style="margin-top: 50px; ">
            ...
            <li style=" font-size: 14px;"><a style="color: #3366FF" href="addbegin.php"><b>ADD BEGIN</b></a></li>
                    ...
                    <tr><td bgcolor=#eee style="padding:8px"><br>
                            <table >
                                <tr >
                                    <?php
                                    echo "\t<tr>\n";
                                    echo "\t\t<td style='padding:4px'><b><h3>Begin </h3></b></td>";
                                    echo "\t\t<td style='padding:4px'><b><h3>begin syn 1</h3></b></td>";
                                    echo "\t\t<td style='padding:4px'><b><h3>begin syn 2</h3></b></td>";
                                    echo "\t\t<td style='padding:4px'><b><h3>begin syn 3</h3></b></td>";
                                    echo "\t\t<td style='padding:4px'><b><h3>begin syn 4</h3></b></td>";
                                    echo "\t\t<td style='padding:4px'><b><h3>begin syn 5</h3></b></td>";
                                    echo "\t\t<td style='padding:4px'><b><h3>begin syn 6</h3></b></td>";
                                    echo "\t\t<td style='padding:4px'><b><h3>begin syn 7</h3></b></td>";
                                    echo "\t\t<td style='padding:4px'><b><h3>begin syn 8</h3></b></td>";
                                    echo "\t</tr>\n";
                                    ...
                                    while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) {
                                        ...
                                        echo "\t\t<td style='padding:4px'><a href='editbegin.php?id=$id'>Edit Record $id </a></td>\n";
                                        echo "\t</tr>\n";
                                    }
                                    // Free resultset
