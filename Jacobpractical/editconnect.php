...
$sql="SELECT * FROM $tbl_name WHERE Connect='$id'";
        ...
        <tr><td bgcolor="blue" style='width: 850px'>
                <table cellpadding='0' cellspacing='5px' border='5px' width='100%'>
                    ...
                    <tr><td bgcolor=#eee style="padding:8px"><br>
                            <form method="post" action="editconnectaction.php?id=<?php echo $id ?>" name="addsynonyms" target="_top" onsubmit="return validateAdmin()">
                                <table >
                                    <tr >
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="txtconnectsyn9" size="21" value=""></td>
                                    </tr>
                                    <tr>
                                        <td style="padding:4px" ><font face="verdana,arial" size=2>connectt syn 10</font></td>
                                        <td><input type="text" name="txtconnectsyn10" size="21"></td>
                                    </tr>
                                    <tr>
                                        <td style="padding:4px" ><font face="verdana,arial" size=2>connect syn 11</font></td>
                                        <td><input type="text" name="txtconnectsyn11" size="21"></td>
                                    </tr>

                                    <tr >
                                        <td style="padding:4px" ><font face="verdana,arial" size=2>connect syn 12 </font></td>
                                        <td  ><input type="text" name="txtconnectsyn12" size="21"></td>
                                    ...
                                    <tr >
                                        ...
                                        <td style="padding:4px" ><input style="padding:4px" type="submit" value="Save">
                                            <input style="padding:4px" type="button" value="Delete" name="btnDelete" onclick="javascript:location.href='delconnect.php?id=<?php echo $id ?>'">
